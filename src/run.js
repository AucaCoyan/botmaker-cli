...
const caRunnerModule = require('./caRunner');
const caRunner = caRunnerModule.runner;
...
const caEndpointRunnerModule = require('./caEndpointRunner');
const caEndpointRunner = caEndpointRunnerModule.endpointRunner;
  ...
  app.use((req, res, next) => {
    ...
    res.on('finish', () => {
      ...
      if (res.statusCode >= 200 && res.statusCode < 300) {
        console.log(
          chalk.green(` Res [${res.statusCode}] on ${end - start}ms`),
        );
      } else {
