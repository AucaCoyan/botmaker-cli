...
function caRunner(code: string, context: Context, helpers: object, fulfill, token, filename: string) {
    ...
    try {
        ...
        const connectRedis = () => {
            const redis = __redisLib__.createClient(
                6379,
                "redis.botmaker.com",
                {
                    password: token,
        ...
        const result = {
            gotoRule: (gotoRuleName) =>
                (resultState.gotoRuleName = gotoRuleName),
            ...
            appleBusinesChatCustomInteractiveMessage: (nextIntentName) => {
                return {
                    ...
                    addImageReferenceURL: function (
                        ...
                        this.message.ABC_IMAGES =
                            this.message.ABC_IMAGES.concat(url);
                        return this;
                    },
            ...
            appleBusinesChatApplePay: (nextIntentName, problemsIntentName) => {
                return {
                    ...
                    addLineItem: function (amount, label) {
                        ...
                        this.message.ABC_PAY_PAYMENT = {
                            ...this.message.ABC_PAY_PAYMENT,
                            items: this.message.ABC_PAY_PAYMENT.items.concat(
                                itm,
                            ),
                        };
            ...
            appleBusinesChatListPicker: (nextIntentName) => {
                return {
                    ...
                    addSection: function (
                        ...
                        this.message.ABC_SECTIONS =
                            this.message.ABC_SECTIONS.concat(sec);
                        return sec;
                    },
                    ...
                    send: function () {
                        resultState.say.push({
                            ...
                            ITEMS: [
                                {
                                    ...this.message,
                                    ABC_SECTIONS: this.message.ABC_SECTIONS.map(
                                        (m) => ({
                                            title: m.title,
                                            multipleSelection:
                                                m.multipleSelection,
