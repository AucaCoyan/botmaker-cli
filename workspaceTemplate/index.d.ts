...
interface AppleBusinesChatApplePay {
	...
	setPayment: (
		...
		itemMerchantCapabilities: string,
		merchantPem: string,
		merchantPublicKey: string,
		paymentProcessorPrivateKey: string,
...
interface AppleBusinesChatListPickerSection {
	addItem: (
		...
		imageRefIndex?: number,
		style?: AppleIconStyles,
		subTitle?: string,
	) => AppleBusinesChatListPickerSection;
}
...
interface BmResult {
	...
	appleBusinesChatForms: (
		nextIntentName: string,
		showSummary = false,
		splashImageRefIndex?: number,
		splashHeader?: string,
		splashText?: string,
		splashButtonTitle?: string,
	) => AppleBusinesChatForms;
